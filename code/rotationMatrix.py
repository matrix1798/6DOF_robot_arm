...
#sp.pprint(mat_rot_0_4[:,3])
x_equal = mat_rot_0_4[0,3]
y_equal = mat_rot_0_4[1,3]
z_equal = mat_rot_0_4[2,3]
...
equal_1_x = sp.Eq(sp.simplify(x_equal),x)
equal_1_y = sp.Eq(sp.simplify(y_equal/cos1),y)
equal_1_z = sp.Eq(sp.simplify(z_equal/cos1),z)

print('Znprmalizowane rownnaie X:')
sp.pprint(equal_1_x)

print('Znprmalizowane rownnaie Y:')
sp.pprint(equal_1_y)

rozwiazanie = sp.solve([equal_1_x,equal_1_y],(cos1))

sp.pprint(rozwiazanie)
